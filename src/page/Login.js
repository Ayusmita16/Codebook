...
export function Login(props) {
    ...
    async function handleGuestLogin() {
        try {
            // event.preventDefault();
            const authDetail = {
                email: `${process.env.REACT_APP_GUES_LOGIN}`,
