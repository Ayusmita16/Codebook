...
export function Checkout({ setCheckout }) {
    ...
    async function handleOrderSubmit(event) {
        ...
        try {
            ...
            clearCart();
            nav("/order-summary", { state: { data: data, status: true } })
        } catch (error) {
                        ...
                        <div className="py-6 px-6 lg:px-8">
                            ...
                            <form className="space-y-6" >
                                ...
                                <div>
                                    ...
                                    <input type="number" name="card" id="card" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:value-gray-400 dark:text-white" value="1233467" disabled required="" />
                                </div>
                                <div className="">
                                ...
                                <button onClick={(e) => { handleOrderSubmit(e) }} type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700" >
